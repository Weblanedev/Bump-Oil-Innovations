...
const Navbar = () => {
  ...
  return (
    <nav
      id="navbar"
      className={`px-[40px] md:px-[130px] z-40 py-[18px] border-b border-green-900/10 flex items-center justify-between w-full top-[0px] left-0 fixed bg-white`}
    >
      <Link
        to="/"
        className="text-[20px] md:text-[30px] font-bold text-[#333333]"
      >
        Bump Oil Innovations 
      </Link>
      ...
      <div
        className={`pb-[5px] transition duration-300 ease-in-out ${navbarVisible ? "top-[66px]" : "-top-[300px]"
          } shadow-2xl shadow-green-900/20 flex flex-col items-center justify-between w-full left-0 absolute bg-white px-10 md:hidden`}
      >
        <Link
          to="/products"

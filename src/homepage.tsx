    ...
    <>
      <section className='header'>
        <div className='text-box'>
          <h1>Welcome to Bump Oil Innovations
</h1>
          <p>Where we are dedicated to providing innovative energy solutions that meet the evolving demands of the market. </p>

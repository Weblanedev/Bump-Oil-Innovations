    ...
    <div className="w-full h-full flex flex-col pt-[66px] md:pt-[80px]">
      <section className="relative h-[250px] md:h-[300px]">
        <div className="flex flex-col gap-2 items-center justify-center h-full w-full">
          ...
          <p>Find the best way to get help and connect with Bump Oil Innovations </p>
        </div>
      </section>
        ...
        <div className="w-full flex gap-8 flex-col items-center justify-center lg:border-r pr-10">
          ...
          <div className="w-full md:w-[720px]">
            ...
            >
              ...
              <button
                type="submit"
                className="text-base font-medium text-white bg-green-400 rounded-md px-7 md:px-12 py-[15px] hover:bg-green-600 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-green-400"
        ...
        <div className="flex flex-col gap-10 items-start justify-center max-w-[300p x] md:w-full">
          ...
          <div className="flex gap-5 items-start justify-center">
            ...
            <div className="flex flex-col items-start justify-center gap-3">
              ...
              <p className="text-green-500 leading-normal capitalize">
              4, Mogaji Ganiyu Street, Checkpoint, Agbara, Lagos State, Nigeria
              </p>
            </div>
          </div>
        </div>
